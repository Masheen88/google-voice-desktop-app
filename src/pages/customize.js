(async function () {
  ...
  startAutomatically.checked = await ipcRenderer.invoke(
  ...
  minimizedSetting.checked =
    prefs.startMinimized != undefined
      ? prefs.startMinimized
      : constants.DEFAULT_SETTING_START_MINIMIZED;
  ...
  hideDialerSidebar.checked =
    prefs.hideDialerSidebar != undefined
      ? prefs.hideDialerSidebar
